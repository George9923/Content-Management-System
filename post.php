        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin'){
                    ...
                    $query = "SELECT * FROM posts WHERE post_id = $the_post_id AND post_status = 'publised";
                }
                ...
                <div class="row">
                    <p class="pull-right likes">Likes: <?php echo getPostlikes($the_post_id);?></p>
                </div>
    ...
    ?>
                ...
                <!-- Posted Comments -->
                    ...
                    <?php 
                        ...
                        while($row = mysqli_fetch_array($select_all_comments)){
